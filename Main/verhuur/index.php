...
$query_Recordset1 = "SELECT * FROM vast WHERE vast.id = 12";
$Recordset1 = mysql_query($query_Recordset1, $chirodon_chirodb) or die(mysql_error());
...
<div class="container">
  ...
  <div class="navcontainer">
    <div class="nav">
      <ul>
        ...
        <li><a href="index.php">Verhuur</a></li>
  ...
  <!-- end .sidebar1 --></div>
    ...
    <div class="content">
      <h1><?php echo $row_Recordset1['titel']; ?></h1>
      <section> <?php echo $row_Recordset1['bericht']; ?> </section>
      <!-- end .content -->
    </div>
    <!-- InstanceEndEditable -->
    <div class="sidebar 2">
