...
$query_Links = "SELECT * FROM links WHERE links.toon = 'j'";
$Links = mysql_query($query_Links, $chirodon_chirodb) or die(mysql_error());
...
<div class="container">
  ...
  <div class="navcontainer">
    <div class="nav">
      <ul>
        ...
        <li><a href="../werkgroep/index.php">Werkgroepen</a>
          <ul>
            <li><a href="../werkgroep/index.php">Leiding</a></li>
            <li><a href="../werkgroep/index.php">Veebees</a></li>
            <li><a href="../werkgroep/ole.php">Ol&eacute;</a></li>
            <li><a href="../werkgroep/vzw.php">VZW</a></li>
          </ul>
        </li>
        <li><a href="../verhuur/index.php">Verhuur</a></li>
        <li><a href="../contact/index.php">Contact</a></li>
        <li><a href="index.php">Nuttige links &amp; weetjes</a></li>
      </ul>
      <br class="clearfloat" />
    </div>
  </div>
  ...
  <!-- end .sidebar1 --></div>
    ...
    <div class="content">
      <h1>Nuttige links en weetjes</h1>
      <section align="center">Links worden steeds in een nieuw venster getoond.<br />
      Sluit het venter om terug te keren naar deze pagina. </section>
      <section align="center">
      <?php do { ?>        
		<a href='http://<?php echo $row_Links['url']; ?>' target="_blank"><?php echo $row_Links['url']; ?></a><br />
        <?php echo $row_Links['omschrijving']; ?><br />
