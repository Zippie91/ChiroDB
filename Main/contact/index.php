...
$query_VastContact = "SELECT * FROM vast WHERE vast.id = 11";
$VastContact = mysql_query($query_VastContact, $chirodon_chirodb) or die(mysql_error());
$row_VastContact = mysql_fetch_assoc($VastContact);
$totalRows_VastContact = mysql_num_rows($VastContact);
?>
<!doctype html>
...
<div class="container">
  ...
  <!-- end .sidebar1 --></div>
    ...
    <div class="content">
      <h1><?php echo $row_VastContact['titel']; ?></h1>
      <section><?php echo $row_VastContact['bericht']; ?></section>
      <!-- end .content -->
    </div>
    <!-- InstanceEndEditable -->
    <div class="sidebar 2">
