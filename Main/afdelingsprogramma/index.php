  ...
  <div class="navcontainer">
    <div class="nav">
      <ul>
        ...
        <li><a href="index.php">Afdelingsprogramma's</a>
          <ul>
            <li><a href="index.php">Ribbels</a></li>
            <li><a href="index.php">Rakwi&prime;s</a></li>
            <li><a href="index.php">Tito&prime;s</a></li>
            <li><a href="index.php">Kea&prime;s</a></li>
          </ul>
        </li>
