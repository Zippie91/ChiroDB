...
$query_vzw = "SELECT * FROM vast WHERE vast.id = 16";
$vzw = mysql_query($query_vzw, $chirodon_chirodb) or die(mysql_error());
$row_vzw = mysql_fetch_assoc($vzw);
$totalRows_vzw = mysql_num_rows($vzw);
?>
<!doctype html>
...
<div class="container">
  ...
  <!-- end .sidebar1 --></div>
    ...
    <div class="content">
      <h1><?php echo $row_vzw['titel']; ?></h1>
      <section><?php echo $row_vzw['bericht']; ?></section>
      <!-- end .content -->
    </div>
    <!-- InstanceEndEditable -->
    <div class="sidebar 2">
